    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative">
      ...
      <div className="w-full max-w-md glass-thick rounded-[32px] border-white/5 p-8 md:p-10 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-2 mb-8 text-center sm:text-left">
          ...
          <p className="text-sm text-slate-400">Log in to manage and split your group balances.</p>
        </div>
        ...
        <p className="mt-8 text-center text-xs text-slate-400">
          New to SplitID?{' '}
          <Link href="/signup" className="text-indigo-400 hover:underline font-bold">
            Create an account
          </Link>
        </p>
      </div>
